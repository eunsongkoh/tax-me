...
function Home() {
  ...
  return (
    <div className="flex flex-wrap justify-center flex-col items-center text-center h-screen">
      <div>
        <h1 className="text-4xl font-h1">taxMe</h1>
        <h2 className="font-display">
          <i>your spending monitor & homie</i>
        </h2>
        <h3 className="font-display m-2 p-4">
          Have your tax calculated for you in real time while you shop & track
      ...
      <div className="flex flex-wrap justify-center flex-col">
        ...
        <button
          type="button"
          className="font-display text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700 btn-width"
        >
          <b>Sign In/Sign Up</b>
        </button>
        <button
          type="button"
          className="font-display text-white bg-[#050708] hover:bg-[#050708]/90 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#050708]/50 dark:hover:bg-[#050708]/30 me-2 mb-2 btn-width"
        >
          <svg
